...
case $software in
    ...
    2) echo "You have selected the ImagicalMine Software! Installing it right now!" && wget http://ws.captainduck.xyz/uploads/5/4/8/6/54868769/pocketmine-installer.sh && chmod +x pocketmine-installer.sh && ./pocketmine-installer.sh && wget http://ws.captainduck.xyz/uploads/5/4/8/6/54868769/imagicalmine-installer.sh && chmod +x imagicalmine-installer.sh && ./imagicalmine-installer.sh && 1 && echo "Just do ./start.sh then Setup wizard will run! Good Luck! :D"
echo "If you have accidentally crashed/stop your server, please do screen ./start.sh or screen -S then ./start.sh, To go back to your server console/screen, Do screen -r or screen -r (screen name)";;
    3) echo "You have selected the Genisys Software! Installing it right now!" && wget http://ws.captainduck.xyz/uploads/5/4/8/6/54868769/pocketmine-installer.sh && chmod +x pocketmine-installer.sh && ./pocketmine-installer.sh && wget http://ws.captainduck.xyz/uploads/5/4/8/6/54868769/genisys-installer.sh && chmod +x genisys-installer.sh && ./genisys-installer.sh && 1 && echo "Just do ./start.sh then Setup wizard will run! Good Luck! :D"
echo "If you have accidentally crashed/stop your server, please do screen ./start.sh or screen -S then ./start.sh, To go back to your server console/screen, Do screen -r or screen -r (screen name)";;
