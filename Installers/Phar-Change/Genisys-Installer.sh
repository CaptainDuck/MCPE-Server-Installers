...
wget https://jenkins.mcper.cn/job/Genisys-master/406/artifact/artifact/Genisys_1.1dev-406.phar && mv 'Genisys_1.1dev-406.phar' PocketMine-MP.phar && echo "Genisys Phar Change succeeded! Please start your server to see the changes. :D";;
